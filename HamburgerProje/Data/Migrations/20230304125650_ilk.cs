    ...
    public partial class ilk : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HamburgerMenu", x => new { x.HamburgerlerId, x.MenulerId });
                    table.ForeignKey(
                        name: "FK_HamburgerMenu_Hamburgerler_HamburgerlerId",
                        column: x => x.HamburgerlerId,
                        principalTable: "Hamburgerler",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HamburgerMenu_Menuler_MenulerId",
                        column: x => x.MenulerId,
                        principalTable: "Menuler",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HamburgerMenu_MenulerId",
                table: "HamburgerMenu",
                column: "MenulerId");
